      ...
      <div className="max-w-7xl mx-auto px-6 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center">
          <div className="lg:col-span-7 text-center lg:text-left">
            ...
            <h1 className="text-6xl sm:text-7xl lg:text-8xl font-extrabold leading-none tracking-tighter text-gray-100 mb-6">
              ARRIVAL
            </h1>
            ...
            <p className="text-lg lg:text-xl text-gray-400 leading-relaxed max-w-xl mx-auto lg:mx-0 mb-10">
              ...
              team, led by linguistics expert Louise Banks, is brought together
              to investigate.
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              >
                <span className="relative z-10">Track This Film</span>
